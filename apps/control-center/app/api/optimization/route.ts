...
export async function GET(request: Request) {
  ...
  const rate = checkRateLimit(request, 'optimization');
  ...
  return NextResponse.json({ generatedAt: overview.generatedAt, range, recommendations: overview.recommendations, scorecards: overview.scorecards });
}
