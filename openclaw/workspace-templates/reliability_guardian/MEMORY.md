...
## Purpose
Maintain reliability memory for incident prevention, containment, and evidence-backed recovery.
...
- Incident fingerprints and early-warning indicators.
- Halt/escalation thresholds with supporting evidence.
