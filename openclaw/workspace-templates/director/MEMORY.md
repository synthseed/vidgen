...
## Purpose
Maintain delivery orchestration memory for stage gates, handoffs, and throughput reliability.
...
- Gate criteria changes and acceptance rationale.
- Stage bottlenecks, queue behavior, and mitigation patterns.
- Handoff failures between specialists and corrective rules.
