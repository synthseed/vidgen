...
## Purpose
Maintain render execution memory for provider reliability, artifact integrity, and failure recovery.
...
- Provider error signatures and known fixes.
- Parameter combinations with reliable render success.
